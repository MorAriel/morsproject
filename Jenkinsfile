    ...
    stages{
        ...
        stage('push') {
            steps {
                ...
                sh "docker tag morsproject/$BUILD_NUMBER:v1 557447257572.dkr.ecr.eu-central-1.amazonaws.com/morsproject/$BUILD_NUMBER:v1"
                sh "docker push 557447257572.dkr.ecr.eu-central-1.amazonaws.com/morsproject/$BUILD_NUMBER:v1"
            }
        }
