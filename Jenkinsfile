pipeline {
    ...
    stages{
		...
		sh "pwd"   
		sh "ls"
                sh "docker build -t mor/$BUILD_NUMBER:v1.0 app1/"
                }
            }
        ...
        stage('push') {
            steps {
                ...
                sh "docker tag morsproject:$BUILD_NUMBER 557447257572.dkr.ecr.eu-central-1.amazonaws.com/morsproject:$BUILD_NUMBER"
